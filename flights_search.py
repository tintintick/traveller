...
def extract_flight_info(data):
    ...
    for flight in flights:
        item = {'arr_city': data['arrCityName'],
                ...
                'flightType': [key for key,value in type_map.items() if flight['flightType'] in value],
...
class FlightSearchClass(object):
    ...
    def search_flight(self, dept_city_name, arr_city_name, dept_date):
        ...
        self.url_dict['args']['depCityName'] = quote(dept_city_name)
        self.url_dict['args']['arrCityName'] = quote(arr_city_name)
        self.url_dict['args']['depDate'] = quote(dept_date)
        ...
        extract_flight_info(ajson['data'])
